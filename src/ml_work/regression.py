...
class Regression_model:
    ...
    def combine_dataframes(self, raw_data_df, feature_df):
        ...
        self._combined_dataframe["target"] = 1  # default = flat
    ...
    def run_random_forest_regression(self):
        ...
        print(
            np.unique(self._model_forest_reg.predict(self._x))
        )  # returns [0.20141806 0.20218758 0.20556417 ... 0.81441768 0.81523677 0.82363257], retuns probabilities
    ...
    def backtest_strategy(self):
        ...
        threshold_top = self._combined_dataframe.loc[mask, "predicted_signal"].quantile(0.95)
        threshold_bottom = self._combined_dataframe.loc[mask, "predicted_signal"].quantile(0.1)
        ...
        sharpe_roll =sh_numerator/sh_denominator
