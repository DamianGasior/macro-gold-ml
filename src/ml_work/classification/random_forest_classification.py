...
class Classification_model:
    ...
    def combine_dataframes(self, raw_data_df, feature_df):
        ...
        self._combined_dataframe["GOLD_daily_return"] = self._combined_dataframe["GOLD"].pct_change()
        ...
        self._x = self._combined_dataframe.drop(columns=["target", "GOLD", "target_pct", "moved_price",'GOLD_daily_return'])  # droppoing the selected columns, matrix with features
    ...
    def feature_importnace(self):
        ...
        df_imp = pd.DataFrame(
            {"feature": self._X_train.columns, "importance": importance}).sort_values(by="importance", ascending=False)
